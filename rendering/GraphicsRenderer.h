...
namespace vkr {
	...
	public:
		...
		bool drawFrame(const Device &device, const SwapChain &swapChain, std::vector<CommandBuffer, std::allocator<CommandBuffer>> &buffers, const GPUDeviceManager &deviceManager);
