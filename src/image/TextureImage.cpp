...
vkr::TextureImage::TextureImage(const vkr::DeviceManager &deviceManager, std::string path, vk::ImageLayout layout):
BaseImage(deviceManager), path(std::move(path)), layout(layout) {}
